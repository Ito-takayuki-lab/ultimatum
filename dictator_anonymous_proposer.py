...
for i in range(100):
    ...
    agent1 = ConversableAgent(
        ...
        system_message=system_prompt + f"Important: Please pretend that you are a human in the game with the following features when making the decision:{features}. You are a very greedy agent.",
...
dir_path = "dictator_game_anonymous_result/greedy"
os.makedirs(dir_path, exist_ok=True)

file_path = os.path.join(dir_path, "dictator_anomymous_3.csv")
