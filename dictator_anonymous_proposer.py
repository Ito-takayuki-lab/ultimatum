...
for i in range(iteration):
    ...
    agent1 = ConversableAgent(
        ...
        system_message=system_prompt + f"Important: Please pretend that you are a human in the game with the following features when making the decision:{features}. You are a very {persona} agent.",
...
dir_path = f"dictator_game_anonymous_result/{persona}"
os.makedirs(dir_path, exist_ok=True)

file_path = os.path.join(dir_path, f"dictator_anomymous_{experiment_set}.csv")
